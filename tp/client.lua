...
addEventHandler("onClientGUIClick",botoncerrar,cerrarboton)


function darvida1()
	 triggerServerEvent ("onBotonVida", localPlayer )
end
addEventHandler("onClientGUIClick",botonvida,darvida1)